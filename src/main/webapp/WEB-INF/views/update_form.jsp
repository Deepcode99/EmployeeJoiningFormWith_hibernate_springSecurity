...
<form:form class="container" action="${pageContext.request.contextPath}/admin/updateform" modelAttribute="EmployeeUpdate" method="post">
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												<label class="form-label" for="form3Example1m">Full
													...
													class="form-control form-control-lg" name="name" value="${EmployeeUpdate.name}" />
											</div>
										</div>
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												<label class="form-label" for="form3Example1m">Employee
													...
													class="form-control form-control-lg" name="employeeCode"  value="${EmployeeUpdate.employeeCode }" readonly />
										...
										<div class="col-md-6 mb-4">
											<div class="form-outline">
												<label class="form-label" for="form3Example1n1">Father's
													...
													class="form-control form-control-lg" name="fatherName"  value="${EmployeeUpdate.fatherName }" />
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													<label for="phone">Phone number:</label> <input type="tel"
														placeholder="+91 0000-0000-00" name="phoneNumber"  value="${EmployeeUpdate.phoneNumber}"
														 id="form3Example1m" 
											...
											<div class="col-md-6 mb-4">
												<div class="form-outline">
													<label for="email">Email Id:</label> <input type="email" name="emailId"
														id="form3Example1m" class="form-control form-control-lg" value="${EmployeeUpdate.emailId}"
										...
										<div class="row">
											<div class="col-md-6 mb-4">
                                             ...
                                             <label
												...
												<input type="text" id="form3Example9" name="dateOfBirth"  value =" ${EmployeeUpdate.dateOfBirth}"
													class="form-control form-control-lg" /> 
											</div>
											</div>
